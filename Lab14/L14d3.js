...
app.post("/login", function (request, response) {
    ...
    //check if the username exists in the user_reg_data
    if (typeof user_reg_data[username_entered] !='undefined') {
        //check if the password mwatches with the username 
...
<input type="submit" value="Submit" id="submit">
 ...
 app.post("/register", function (request, response) {
    ...
    if (errors) {
        ...
        //redirect to the register page with an error query parameter
    }
 });